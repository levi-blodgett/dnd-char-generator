...
export function format_initial_dropdowns(list, listItems) {
...
export function format_secondary_dropdowns(list, listItems, checkbox) {
  let checkList = document.getElementById(list);
  let items = document.getElementById(listItems);
...
export function hide_dropdowns(dropdownValue) {
...
export function on_click_decider(_id, _class) {
...
export function on_subrace_dropdown_option_click(e) {
...
export const add_events_for_dropdowns = (
...
export function on_dropdown_option_click(_id, _class) {
  let ID = _id;
  let input_class = _class;
...
// Wire up all dropdown event listeners and format all dropdowns.
// Must be called after index.html DOM is ready.
export function initDropdowns() {
  // Section that adds click event listeners to the random buttons
